        ...
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-y-10 px-4 pt-10'>
                    ...
                    {/* Product info */}
                    <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7x1 lg:px-8 lg:pb-24">
                ...
                <section>
                    ...
                    <div className='border p-5'>
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5} >
                                <h1 className='text-xl font-semibold pb-2 text-left'>Product Ratings</h1>
                                <div className='flex items-center  space-x-3'>
